...
\begin{tabu} to \linewidth {p{2.9cm} X}
	\tabucline[1.5pt]-
	\textit{Use case name} & \RetrieveStudyInformation \,using:\, \manageStudy \\
	\hline
	...
	\begin{enumerate}[leftmargin=*,topsep=0pt,itemsep=-1ex]
		\item The \client activates the Manage Study use case.
		\item The \client specifies the study information to retrieve.
		\item The \client confirms the retrieval of details regarding the Study. An error message is displayed if the provided data is insufficient  \newline
