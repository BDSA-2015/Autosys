\section{Scenarios}
This section contains various scenarios regarding operations between the user and the system.\footnote{Note that we are missing task scenarios and use cases because their definition was clarified late in development process.}
